...
Bio::GeneSigDB::Array - Class representing the array from which a
given probe Element identifier is taken.

=head1 SYNOPSIS

 use Bio::GeneSigDB::Array;
