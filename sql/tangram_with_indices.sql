...
--
-- Table structure for table `Bio_GeneSigDB_Array`
--

DROP TABLE IF EXISTS `Bio_GeneSigDB_Array`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `Bio_GeneSigDB_Array` (
  `id` int(11) NOT NULL,
  `manufacturer` varchar(255) default NULL,
  PRIMARY KEY  (`id`),
  FOREIGN KEY (`id`) REFERENCES `Bio_GeneSigDB_Platform` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;

--
-- Dumping data for table `Bio_GeneSigDB_Array`
--

LOCK TABLES `Bio_GeneSigDB_Array` WRITE;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Array` DISABLE KEYS */;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Array` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Bio_GeneSigDB_Category`
--

DROP TABLE IF EXISTS `Bio_GeneSigDB_Category`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `Bio_GeneSigDB_Category` (
  `id` int(11) NOT NULL,
  `type` int(11) NOT NULL,
  `parentCategory` int(11) default NULL,
  `name` varchar(255) default NULL,
  `parentCategory_type` int(11) default NULL,
  PRIMARY KEY  (`id`),
  FOREIGN KEY (`parentCategory`) REFERENCES `Bio_GeneSigDB_Category` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;

--
-- Dumping data for table `Bio_GeneSigDB_Category`
--

LOCK TABLES `Bio_GeneSigDB_Category` WRITE;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Category` DISABLE KEYS */;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Bio_GeneSigDB_Category_categories`
--

DROP TABLE IF EXISTS `Bio_GeneSigDB_Category_categories`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `Bio_GeneSigDB_Category_categories` (
  `item` int(11) default NULL,
  `coll` int(11) default NULL,
  `slot` int(11) default NULL,
  FOREIGN KEY (`coll`) REFERENCES `Bio_GeneSigDB_Signature` (`id`) ON DELETE CASCADE,
  FOREIGN KEY (`item`) REFERENCES `Bio_GeneSigDB_Category` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;

--
-- Dumping data for table `Bio_GeneSigDB_Category_categories`
--

LOCK TABLES `Bio_GeneSigDB_Category_categories` WRITE;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Category_categories` DISABLE KEYS */;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Category_categories` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Bio_GeneSigDB_Database`
--

DROP TABLE IF EXISTS `Bio_GeneSigDB_Database`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `Bio_GeneSigDB_Database` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `Bio_GeneSigDB_Database`
--

LOCK TABLES `Bio_GeneSigDB_Database` WRITE;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Database` DISABLE KEYS */;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Database` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Bio_GeneSigDB_Element`
--

DROP TABLE IF EXISTS `Bio_GeneSigDB_Element`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `Bio_GeneSigDB_Element` (
  `id` int(11) NOT NULL,
  `type` int(11) NOT NULL,
  ...
  PRIMARY KEY  (`id`),
  FOREIGN KEY (`platform`) REFERENCES `Bio_GeneSigDB_Platform` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;

--
-- Dumping data for table `Bio_GeneSigDB_Element`
--

LOCK TABLES `Bio_GeneSigDB_Element` WRITE;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Element` DISABLE KEYS */;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Element` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Bio_GeneSigDB_Element_elements`
--

DROP TABLE IF EXISTS `Bio_GeneSigDB_Element_elements`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `Bio_GeneSigDB_Element_elements` (
  `item` int(11) default NULL,
  `coll` int(11) default NULL,
  `slot` int(11) default NULL,
  FOREIGN KEY (`coll`) REFERENCES `Bio_GeneSigDB_Signature` (`id`) ON DELETE CASCADE,
  FOREIGN KEY (`item`) REFERENCES `Bio_GeneSigDB_Element` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;

--
-- Dumping data for table `Bio_GeneSigDB_Element_elements`
--

LOCK TABLES `Bio_GeneSigDB_Element_elements` WRITE;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Element_elements` DISABLE KEYS */;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Element_elements` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Bio_GeneSigDB_MAGETAB`
--

DROP TABLE IF EXISTS `Bio_GeneSigDB_MAGETAB`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `Bio_GeneSigDB_MAGETAB` (
  `id` int(11) NOT NULL,
  ...
  `investigation_type` int(11) default NULL,
  PRIMARY KEY  (`id`),
  FOREIGN KEY (`id`) REFERENCES `Bio_GeneSigDB_Provenance` (`id`) ON DELETE CASCADE,
  FOREIGN KEY (`test`) REFERENCES `Bio_MAGETAB_FactorValue` (`id`),
  FOREIGN KEY (`reference`) REFERENCES `Bio_MAGETAB_FactorValue` (`id`),
  FOREIGN KEY (`investigation`) REFERENCES `Bio_MAGETAB_Investigation` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;

--
-- Dumping data for table `Bio_GeneSigDB_MAGETAB`
--

LOCK TABLES `Bio_GeneSigDB_MAGETAB` WRITE;
/*!40000 ALTER TABLE `Bio_GeneSigDB_MAGETAB` DISABLE KEYS */;
/*!40000 ALTER TABLE `Bio_GeneSigDB_MAGETAB` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Bio_GeneSigDB_Platform`
--

DROP TABLE IF EXISTS `Bio_GeneSigDB_Platform`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `Bio_GeneSigDB_Platform` (
  `id` int(11) NOT NULL,
  `type` int(11) NOT NULL,
  `name` varchar(255) default NULL,
  `biomartFilter` varchar(255) default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;

--
-- Dumping data for table `Bio_GeneSigDB_Platform`
--

LOCK TABLES `Bio_GeneSigDB_Platform` WRITE;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Platform` DISABLE KEYS */;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Platform` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Bio_GeneSigDB_Provenance`
--

DROP TABLE IF EXISTS `Bio_GeneSigDB_Provenance`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `Bio_GeneSigDB_Provenance` (
  `id` int(11) NOT NULL,
  `type` int(11) NOT NULL,
...
--
-- Dumping data for table `Bio_GeneSigDB_Provenance`
--

LOCK TABLES `Bio_GeneSigDB_Provenance` WRITE;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Provenance` DISABLE KEYS */;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Provenance` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Bio_GeneSigDB_PublishedSignature`
--

DROP TABLE IF EXISTS `Bio_GeneSigDB_PublishedSignature`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `Bio_GeneSigDB_PublishedSignature` (
  `id` int(11) NOT NULL,
  `provenance_type` int(11) default NULL,
  `provenance` int(11) default NULL,
  `criteria` varchar(255) default NULL,
  PRIMARY KEY  (`id`),
  FOREIGN KEY (`id`) REFERENCES `Bio_GeneSigDB_Signature` (`id`) ON DELETE CASCADE,
  FOREIGN KEY (`provenance`) REFERENCES `Bio_GeneSigDB_Provenance` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;

--
-- Dumping data for table `Bio_GeneSigDB_PublishedSignature`
--

LOCK TABLES `Bio_GeneSigDB_PublishedSignature` WRITE;
/*!40000 ALTER TABLE `Bio_GeneSigDB_PublishedSignature` DISABLE KEYS */;
/*!40000 ALTER TABLE `Bio_GeneSigDB_PublishedSignature` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Bio_GeneSigDB_Signature`
--

DROP TABLE IF EXISTS `Bio_GeneSigDB_Signature`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `Bio_GeneSigDB_Signature` (
  `id` int(11) NOT NULL,
  `type` int(11) NOT NULL,
  `parentSignature` int(11) default NULL,
  `parentSignature_type` int(11) default NULL,
  `notes` varchar(255) default NULL,
  `name` varchar(255) default NULL,
  `species` varchar(255) default NULL,
  PRIMARY KEY  (`id`),
  FOREIGN KEY (`parentSignature`) REFERENCES `Bio_GeneSigDB_Signature` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;

--
-- Dumping data for table `Bio_GeneSigDB_Signature`
--

LOCK TABLES `Bio_GeneSigDB_Signature` WRITE;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Signature` DISABLE KEYS */;
/*!40000 ALTER TABLE `Bio_GeneSigDB_Signature` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2009-04-19 20:27:30
